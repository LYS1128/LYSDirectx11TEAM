...
public:
	...
	ID3D11ShaderResourceView* Get_LightDepthSRV() const;
public:
	...
	HRESULT Add_LightDepth(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext);
	...
	HRESULT Begin_LightDepth(ID3D11DeviceContext* pDeviceContext);
	HRESULT End_LightDepth(ID3D11DeviceContext* pDeviceContext);
...
public:
	...
	HRESULT Ready_LightDebugDesc(_float fTopX, _float fTopY, _float fWidth, _float fHeight);
	HRESULT Render_LightDebug();
#endif // _DEBUG
...
private:
	...
	class CLightDepth*					m_pLightDepth = nullptr;
