...
HRESULT CVIBuffer_Trail::Render_Start(_float4x4 * Mat)
{
	if (nullptr == m_pDeviceContext)
		return E_FAIL;
...
void CVIBuffer_Trail::Set_LocalPos(_float3 LocalLow, _float3 LocalHigh)
{
	m_vLocalHigh = LocalHigh;
	m_vLocalLow = LocalLow;
