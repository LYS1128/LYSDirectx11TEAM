#include "..\Public\VIBuffer_Resentment_Trail.h"

CVIBuffer_Resentment_Trail::CVIBuffer_Resentment_Trail(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CVIBuffer(pDevice, pDeviceContext)
{
}

CVIBuffer_Resentment_Trail::CVIBuffer_Resentment_Trail(const CVIBuffer_Resentment_Trail & rhs)
	: CVIBuffer(rhs)
{
	m_pDevice->CreateBuffer(&rhs.m_VBDesc, &rhs.m_VBSubResourceData, &m_pVB);
}

HRESULT CVIBuffer_Resentment_Trail::NativeConstruct_Prototype()
{
...
HRESULT CVIBuffer_Resentment_Trail::NativeConstruct(void * pArg)
{
	return S_OK;
}

HRESULT CVIBuffer_Resentment_Trail::Update(_float4x4 * Mat)
{
...
HRESULT CVIBuffer_Resentment_Trail::Render_Start(_float4x4 * Mat)
{
	if (nullptr == m_pDeviceContext)
		return E_FAIL;
...
CVIBuffer_Resentment_Trail * CVIBuffer_Resentment_Trail::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CVIBuffer_Resentment_Trail*	pInstance = new CVIBuffer_Resentment_Trail(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CVIBuffer_Resentment_Trail"));
...
CComponent * CVIBuffer_Resentment_Trail::Clone(void * pArg)
{
	CVIBuffer_Resentment_Trail*	pInstance = new CVIBuffer_Resentment_Trail(*this);
...
void CVIBuffer_Resentment_Trail::Free()
{
	__super::Free();
}
