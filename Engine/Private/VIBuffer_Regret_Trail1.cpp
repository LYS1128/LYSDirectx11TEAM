#include "..\Public\VIBuffer_Regret_Trail1.h"

CVIBuffer_Regret_Trail1::CVIBuffer_Regret_Trail1(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
	: CVIBuffer(pDevice, pDeviceContext)
{
}

CVIBuffer_Regret_Trail1::CVIBuffer_Regret_Trail1(const CVIBuffer_Regret_Trail1 & rhs)
	: CVIBuffer(rhs)
{
	m_pDevice->CreateBuffer(&rhs.m_VBDesc, &rhs.m_VBSubResourceData, &m_pVB);
}

HRESULT CVIBuffer_Regret_Trail1::NativeConstruct_Prototype()
{
...
HRESULT CVIBuffer_Regret_Trail1::NativeConstruct(void * pArg)
{
	return S_OK;
}

HRESULT CVIBuffer_Regret_Trail1::Update(_float4x4 * Mat)
{
...
HRESULT CVIBuffer_Regret_Trail1::Render_Start(_float4x4 * Mat)
{
	if (nullptr == m_pDeviceContext)
		return E_FAIL;
...
CVIBuffer_Regret_Trail1 * CVIBuffer_Regret_Trail1::Create(ID3D11Device * pDevice, ID3D11DeviceContext * pDeviceContext)
{
	CVIBuffer_Regret_Trail1*	pInstance = new CVIBuffer_Regret_Trail1(pDevice, pDeviceContext);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CVIBuffer_Regret_Trail1"));
...
CComponent * CVIBuffer_Regret_Trail1::Clone(void * pArg)
{
	CVIBuffer_Regret_Trail1*	pInstance = new CVIBuffer_Regret_Trail1(*this);
...
void CVIBuffer_Regret_Trail1::Free()
{
	__super::Free();
}
