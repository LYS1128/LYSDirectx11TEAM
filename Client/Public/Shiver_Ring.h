...
class CShiver_Ring final : public CGameObject
{
private:
	explicit CShiver_Ring(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CShiver_Ring(const CShiver_Ring& rhs);
	virtual ~CShiver_Ring() = default;
...
public:
	static CShiver_Ring* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
