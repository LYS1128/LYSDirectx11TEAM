...
class CLoader2 final : public CBase
{
private:
	explicit CLoader2(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	virtual ~CLoader2() = default;
...
public:
	static CLoader2* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut, LEVEL eLevel);
