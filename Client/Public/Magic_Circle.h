...
class CMagic_Circle final : public CGameObject
{
public:
...
private:
	explicit CMagic_Circle(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CMagic_Circle(const CMagic_Circle& rhs);
	virtual ~CMagic_Circle() = default;
...
private:
	...
	_double		m_Time = 0.0;
public:
	static CMagic_Circle* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
