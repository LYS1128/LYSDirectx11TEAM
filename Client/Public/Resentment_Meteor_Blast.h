...
class CResentment_Meteor_Blast final : public CGameObject
{
public:
...
private:
	explicit CResentment_Meteor_Blast(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CResentment_Meteor_Blast(const CResentment_Meteor_Blast& rhs);
	virtual ~CResentment_Meteor_Blast() = default;
...
private:
	...
	_double		m_Time = 0.0;
public:
	static CResentment_Meteor_Blast* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
