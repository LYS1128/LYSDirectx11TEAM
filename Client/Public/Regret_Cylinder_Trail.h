...
class CRegret_Cylinder_Trail final : public CGameObject
{
public:
...
private:
	explicit CRegret_Cylinder_Trail(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CRegret_Cylinder_Trail(const CRegret_Cylinder_Trail& rhs);
	virtual ~CRegret_Cylinder_Trail() = default;
...
public:
	static CRegret_Cylinder_Trail* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
