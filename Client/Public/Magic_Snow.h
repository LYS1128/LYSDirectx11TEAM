...
class CMagic_Snow final : public CGameObject
{
public:
...
private:
	explicit CMagic_Snow(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CMagic_Snow(const CMagic_Snow& rhs);
	virtual ~CMagic_Snow() = default;
...
public:
	static CMagic_Snow* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
