...
class CMagic_Six_Shock final : public CGameObject
{
public:
...
private:
	explicit CMagic_Six_Shock(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CMagic_Six_Shock(const CMagic_Six_Shock& rhs);
	virtual ~CMagic_Six_Shock() = default;
...
public:
	static CMagic_Six_Shock* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
