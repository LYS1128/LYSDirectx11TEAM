...
class CPark_Text_UI final : public CUI
{
public:
	enum PARKUI {
...
private:
	explicit CPark_Text_UI(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CPark_Text_UI(const CPark_Text_UI& rhs);
	virtual ~CPark_Text_UI() = default;
...
public:
	static CPark_Text_UI* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
