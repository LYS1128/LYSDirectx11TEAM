...
class CMelee1_Sword final : public CEnemy
{
public:
	enum STATE {
		ATTACK_AOE, ATTACK_BACKSWING, ATTACK_DASH, ATTACK_LIGHT, ATTACK_LINE, ATTACK_SPIN, BLOCK_FAILURE, BLOCK_LOCOMOTION, BLOCK_SUCCESS,
...
private:
	explicit CMelee1_Sword(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CMelee1_Sword(const CMelee1_Sword& rhs);
	virtual ~CMelee1_Sword() = default;
...
public:
	static CMelee1_Sword* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
