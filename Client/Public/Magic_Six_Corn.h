...
class CMagic_Six_Corn final : public CGameObject
{
public:
...
private:
	explicit CMagic_Six_Corn(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CMagic_Six_Corn(const CMagic_Six_Corn& rhs);
	virtual ~CMagic_Six_Corn() = default;
...
public:
	static CMagic_Six_Corn* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
