...
{
private:
	explicit CLand(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CLand(const CLand& rhs);
...
public:
	static CLand* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
