...
class CLoader3 final : public CBase
{
private:
	explicit CLoader3(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	virtual ~CLoader3() = default;
...
public:
	static CLoader3* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut, LEVEL eLevel);
