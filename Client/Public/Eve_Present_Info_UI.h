...
class CEve_Present_Info_UI final : public CUI
{
public:
	enum IDEA_INDEX {
...
private:
	explicit CEve_Present_Info_UI(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CEve_Present_Info_UI(const CEve_Present_Info_UI& rhs);
	virtual ~CEve_Present_Info_UI() = default;
...
private:
	...
	void				Repay();
public:
	static CEve_Present_Info_UI* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
