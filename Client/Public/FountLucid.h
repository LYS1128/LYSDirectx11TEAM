...
class CFountLucid final : public CGameObject
{
private:
	explicit CFountLucid(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CFountLucid(const CFountLucid& rhs);
	virtual ~CFountLucid() = default;
...
public:
	static CFountLucid* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
