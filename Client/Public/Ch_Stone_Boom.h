...
class CCh_Stone_Boom final : public CGameObject
{
public:
...
private:
	explicit CCh_Stone_Boom(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CCh_Stone_Boom(const CCh_Stone_Boom& rhs);
	virtual ~CCh_Stone_Boom() = default;
...
public:
	static CCh_Stone_Boom* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
