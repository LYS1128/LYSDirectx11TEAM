...
class CGoods_Text_Num final : public CUI
{
public:
...
private:
	explicit CGoods_Text_Num(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CGoods_Text_Num(const CGoods_Text_Num& rhs);
	virtual ~CGoods_Text_Num() = default;
...
public:
	static CGoods_Text_Num* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
