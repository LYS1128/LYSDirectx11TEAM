...
class CMagic_Moon_Circle final : public CGameObject
{
public:
...
private:
	explicit CMagic_Moon_Circle(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CMagic_Moon_Circle(const CMagic_Moon_Circle& rhs);
	virtual ~CMagic_Moon_Circle() = default;
...
public:
	static CMagic_Moon_Circle* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
