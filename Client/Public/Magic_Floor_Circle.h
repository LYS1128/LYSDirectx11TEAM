...
class CMagic_Floor_Circle final : public CGameObject
{
public:
...
private:
	explicit CMagic_Floor_Circle(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CMagic_Floor_Circle(const CMagic_Floor_Circle& rhs);
	virtual ~CMagic_Floor_Circle() = default;
...
public:
	static CMagic_Floor_Circle* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
