...
BEGIN(Client)
class CArrow_Trail final : public CGameObject
{
public:
...
private:
	explicit CArrow_Trail(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CArrow_Trail(const CArrow_Trail& rhs);
	virtual ~CArrow_Trail() = default;
...
public:
	static CArrow_Trail* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
