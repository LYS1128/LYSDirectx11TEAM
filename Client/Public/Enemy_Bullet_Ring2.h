...
class CEnemy_Bullet_Ring2 final : public CGameObject
{
public:
...
private:
	explicit CEnemy_Bullet_Ring2(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
	explicit CEnemy_Bullet_Ring2(const CEnemy_Bullet_Ring2& rhs);
	virtual ~CEnemy_Bullet_Ring2() = default;
...
public:
	static CEnemy_Bullet_Ring2* Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut);
