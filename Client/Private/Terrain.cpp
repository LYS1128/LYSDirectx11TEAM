...
HRESULT CTerrain::NativeConstruct(void * pArg)
{
	...
	if (LEVEL_REALITY == CClient_Level_Manager::Get_Instance()->Get_Level())
	{
		CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);

		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/DataNavi_House.dat"), m_pTransformCom)))
			return E_FAIL;
	...
	else if (LEVEL_BAR == CClient_Level_Manager::Get_Instance()->Get_Level())
	{
		...
		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/DataNavi_Bar.dat"), m_pTransformCom)))
			return E_FAIL;
		RELEASE_INSTANCE(CGameInstance);
	}
	else if (LEVEL_PARK == CClient_Level_Manager::Get_Instance()->Get_Level())
	{
		...
		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/DataNavi_Park.dat"), m_pTransformCom)))
			return E_FAIL;
		RELEASE_INSTANCE(CGameInstance);
	}
	else if (LEVEL_COFFEE == CClient_Level_Manager::Get_Instance()->Get_Level())
	{
		...
		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/DataNavi_Coffee.dat"), m_pTransformCom)))
			return E_FAIL;
		RELEASE_INSTANCE(CGameInstance);
	}
	if (LEVEL_GAMEPLAY == CClient_Level_Manager::Get_Instance()->Get_Level()) {
		...
		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/DataNaviAstar.dat"), m_pTransformCom)))
			return E_FAIL;
		CAStar* pAStar = GET_INSTANCE(CAStar);
		pAStar->Set_Cells(*pGameInstance->Get_vecCell());

		RELEASE_INSTANCE(CAStar);
		RELEASE_INSTANCE(CGameInstance);
	}
	if (LEVEL_CITY == CClient_Level_Manager::Get_Instance()->Get_Level()) {
		CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);

		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/City_DataNavi.dat"), m_pTransformCom)))
			return E_FAIL;
		CAStar* pAStar = GET_INSTANCE(CAStar);
		pAStar->Set_Cells(*pGameInstance->Get_vecCell());
	...
	if (LEVEL_LAVA == CClient_Level_Manager::Get_Instance()->Get_Level()) {
		CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);

		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/Lava_DataNavi.dat"), m_pTransformCom)))
			return E_FAIL;
		CAStar* pAStar = GET_INSTANCE(CAStar);
		pAStar->Set_Cells(*pGameInstance->Get_vecCell());
	...
	if (LEVEL_BOSS_FEAR == CClient_Level_Manager::Get_Instance()->Get_Level()) {
		m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(-38.f, 0.f, -32.f, 1.f));
		CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/Boss_Fear_Navi.dat"), m_pTransformCom)))
			return E_FAIL;
		RELEASE_INSTANCE(CGameInstance);
	}
	if (LEVEL_BOSS_REGRET == CClient_Level_Manager::Get_Instance()->Get_Level()) {
		CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/Boss_Regret_Navi.dat"), m_pTransformCom)))
			return E_FAIL;
		RELEASE_INSTANCE(CGameInstance);
	}
	if (LEVEL_BOSS_RESENTMENT == CClient_Level_Manager::Get_Instance()->Get_Level()) {
		CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
		if (FAILED(pGameInstance->Initialize_Navigation(m_pDevice, m_pDeviceContext, TEXT("../Data/Navi/Boss_Resentment_Navi.dat"), m_pTransformCom)))
			return E_FAIL;
		RELEASE_INSTANCE(CGameInstance);
	}
	return S_OK;
...
void CTerrain::Tick(_double TimeDelta)
{
	...
	//m_pTransformCom->Set_State(CTransform::STATE_POSITION, XMVectorSet(-32.f, 0.f, -38.f, 1.f));
}
...
HRESULT CTerrain::SetUp_Components()
{
	...
	/* For.Com_VIBuffer */
	if (FAILED(__super::SetUp_Components(TEXT("Com_VIBuffer"), LEVEL_STATIC, TEXT("Prototype_Component_VIBuffer_Terrain"), (CComponent**)&m_pVIBufferCom)))
		return E_FAIL;
