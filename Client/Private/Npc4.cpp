#include "stdafx.h"
#include "..\Public\Npc4.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc4::CNpc4(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc4::CNpc4(const CNpc4 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc4::NativeConstruct_Prototype()
{
...
HRESULT CNpc4::NativeConstruct(void * pArg)
{
...
void CNpc4::Tick(_double TimeDelta)
{
...
void CNpc4::LateTick(_double TimeDelta)
{
...
HRESULT CNpc4::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc4::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC4"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc4::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc4 * CNpc4::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc4*	pInstance = new CNpc4(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc4"));
...
CGameObject * CNpc4::Clone(void * pArg)
{
	CNpc4*	pInstance = new CNpc4(*this);
