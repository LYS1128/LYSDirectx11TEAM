#include "stdafx.h"
#include "..\Public\Npc6.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc6::CNpc6(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc6::CNpc6(const CNpc6 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc6::NativeConstruct_Prototype()
{
...
HRESULT CNpc6::NativeConstruct(void * pArg)
{
...
void CNpc6::Tick(_double TimeDelta)
{
...
void CNpc6::LateTick(_double TimeDelta)
{
...
HRESULT CNpc6::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc6::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC6"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc6::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc6 * CNpc6::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc6*	pInstance = new CNpc6(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc6"));
...
CGameObject * CNpc6::Clone(void * pArg)
{
	CNpc6*	pInstance = new CNpc6(*this);
