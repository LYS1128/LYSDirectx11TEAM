#include "stdafx.h"
#include "..\Public\Regret_HandTrail0.h"
...
CRegret_HandTrail0::CRegret_HandTrail0(ID3D11Device * pDeviceOut, ID3D11DeviceContext * pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{
}

CRegret_HandTrail0::CRegret_HandTrail0(const CRegret_HandTrail0 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CRegret_HandTrail0::NativeConstruct_Prototype()
{
...
HRESULT CRegret_HandTrail0::NativeConstruct(void * pArg)
{
...
void CRegret_HandTrail0::Tick(_double TimeDelta)
{
...
void CRegret_HandTrail0::LateTick(_double TimeDelta)
{
...
HRESULT CRegret_HandTrail0::Render()
{
...
HRESULT CRegret_HandTrail0::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CRegret_HandTrail0::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CRegret_HandTrail0 * CRegret_HandTrail0::Create(ID3D11Device * pDeviceOut, ID3D11DeviceContext * pDeviceContextOut)
{
	CRegret_HandTrail0*	pInstance = new CRegret_HandTrail0(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CRegret_HandTrail0"));
...
CGameObject * CRegret_HandTrail0::Clone(void * pArg)
{
	CRegret_HandTrail0*	pInstance = new CRegret_HandTrail0(*this);
