#include "stdafx.h"
#include "..\Public\Ch_Stone_Boom_Black.h"
...
CCh_Stone_Boom_Black::CCh_Stone_Boom_Black(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CCh_Stone_Boom_Black::CCh_Stone_Boom_Black(const CCh_Stone_Boom_Black & rhs)
	: CGameObject(rhs)
{
}

HRESULT CCh_Stone_Boom_Black::NativeConstruct_Prototype()
{
...
HRESULT CCh_Stone_Boom_Black::NativeConstruct(void * pArg)
{
	...
	float x,y,z;
	x = (float)(rand() % 30) / 10.f + 0.3f;
	y = (float)(rand() % 15) / 10.f + 0.2f;
	z = (float)(rand() % 20) / 10.f + 1.5f;
...
void CCh_Stone_Boom_Black::Tick(_double TimeDelta)
{
...
void CCh_Stone_Boom_Black::LateTick(_double TimeDelta)
{
	_double TimeRatio = CTime_Manager::Get_Instance()->Get_PlayerRatio();
	_double mTimeDelta = TimeDelta * TimeRatio;
...
HRESULT CCh_Stone_Boom_Black::Render()
{
...
HRESULT CCh_Stone_Boom_Black::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ch_RockBoom2"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
	/* For.Com_Texture */
...
HRESULT CCh_Stone_Boom_Black::SetUp_ConstantTable()
{
...
CCh_Stone_Boom_Black * CCh_Stone_Boom_Black::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CCh_Stone_Boom_Black*	pInstance = new CCh_Stone_Boom_Black(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CCh_Stone_Boom_Black"));
...
CGameObject * CCh_Stone_Boom_Black::Clone(void * pArg)
{
	CCh_Stone_Boom_Black*	pInstance = new CCh_Stone_Boom_Black(*this);
...
void CCh_Stone_Boom_Black::Free()
{
	__super::Free();	
