#include "stdafx.h"
#include "..\Public\Resentment_Meteor_Stone_Effect.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CResentment_Meteor_Stone_Effect::CResentment_Meteor_Stone_Effect(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CResentment_Meteor_Stone_Effect::CResentment_Meteor_Stone_Effect(const CResentment_Meteor_Stone_Effect & rhs)
	: CGameObject(rhs)
{
}

HRESULT CResentment_Meteor_Stone_Effect::NativeConstruct_Prototype()
{
...
HRESULT CResentment_Meteor_Stone_Effect::NativeConstruct(void * pArg)
{
...
void CResentment_Meteor_Stone_Effect::Tick(_double TimeDelta)
{
...
void CResentment_Meteor_Stone_Effect::LateTick(_double TimeDelta)
{
	//_double TimeRatio = CTime_Manager::Get_Instance()->Get_PlayerRatio();
	//_double mTimeDelta = TimeDelta * TimeRatio;
...
HRESULT CResentment_Meteor_Stone_Effect::Render()
{
...
HRESULT CResentment_Meteor_Stone_Effect::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CResentment_Meteor_Stone_Effect::SetUp_ConstantTable()
{
...
CResentment_Meteor_Stone_Effect * CResentment_Meteor_Stone_Effect::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CResentment_Meteor_Stone_Effect*	pInstance = new CResentment_Meteor_Stone_Effect(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CResentment_Meteor_Stone_Effect"));
...
CGameObject * CResentment_Meteor_Stone_Effect::Clone(void * pArg)
{
	CResentment_Meteor_Stone_Effect*	pInstance = new CResentment_Meteor_Stone_Effect(*this);
...
void CResentment_Meteor_Stone_Effect::Free()
{
	__super::Free();	
