#include "stdafx.h"
#include "..\Public\Attack0_Effect2.h"
#include "GameInstance.h"

#include "Equipment_Manager.h"
#include "Time_Manager.h"

CAttack0_Effect2::CAttack0_Effect2(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CAttack0_Effect2::CAttack0_Effect2(const CAttack0_Effect2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CAttack0_Effect2::NativeConstruct_Prototype()
{
...
HRESULT CAttack0_Effect2::NativeConstruct(void * pArg)
{
...
void CAttack0_Effect2::Tick(_double TimeDelta)
{
...
void CAttack0_Effect2::LateTick(_double TimeDelta)
{
	_double TimeRatio = CTime_Manager::Get_Instance()->Get_PlayerRatio();
	_double mTimeDelta = TimeDelta * TimeRatio;
...
HRESULT CAttack0_Effect2::Render()
{
...
HRESULT CAttack0_Effect2::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_Attack0_Effect2"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CAttack0_Effect2::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CAttack0_Effect2 * CAttack0_Effect2::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CAttack0_Effect2*	pInstance = new CAttack0_Effect2(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CAttack0_Effect2"));
...
CGameObject * CAttack0_Effect2::Clone(void * pArg)
{
	CAttack0_Effect2*	pInstance = new CAttack0_Effect2(*this);
