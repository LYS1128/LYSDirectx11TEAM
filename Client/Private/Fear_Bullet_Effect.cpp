#include "stdafx.h"
#include "..\Public\Fear_Bullet_Effect.h"
#include "GameInstance.h"

#include "Stage_Manager.h"
#include "Time_Manager.h"

CFear_Bullet_Effect::CFear_Bullet_Effect(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{
}

CFear_Bullet_Effect::CFear_Bullet_Effect(const CFear_Bullet_Effect & rhs)
	: CGameObject(rhs)
{
}

HRESULT CFear_Bullet_Effect::NativeConstruct_Prototype()
{
...
HRESULT CFear_Bullet_Effect::NativeConstruct(void * pArg)
{
...
void CFear_Bullet_Effect::Tick(_double TimeDelta)
{
...
void CFear_Bullet_Effect::LateTick(_double TimeDelta)
{
	_double TimeRatio = CTime_Manager::Get_Instance()->Get_MonsterRatio();
	_double mTimeDelta = TimeDelta * TimeRatio;
...
HRESULT CFear_Bullet_Effect::Render()
{
...
HRESULT CFear_Bullet_Effect::SetUp_Components()
{
	/* For.Com_Renderer */
...
CFear_Bullet_Effect * CFear_Bullet_Effect::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CFear_Bullet_Effect*	pInstance = new CFear_Bullet_Effect(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CFear_Bullet_Effect"));
...
CGameObject * CFear_Bullet_Effect::Clone(void * pArg)
{
	CFear_Bullet_Effect*	pInstance = new CFear_Bullet_Effect(*this);
