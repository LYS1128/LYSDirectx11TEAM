#include "stdafx.h"
#include "..\Public\LavaObject.h"
#include "GameInstance.h"
#include "Stage_Manager.h"
#include "Time_Manager.h"
#include "Client_Level_Manager.h"

CLavaObject::CLavaObject(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CLavaObject::CLavaObject(const CLavaObject & rhs)
	: CGameObject(rhs),
...
HRESULT CLavaObject::NativeConstruct_Prototype()
{
...
HRESULT CLavaObject::NativeConstruct(void * pArg)
{
...
void CLavaObject::Tick(_double TimeDelta)
{
...
void CLavaObject::LateTick(_double TimeDelta)
{
	_double mTimeDelta = CTime_Manager::Get_Instance()->Time_Stop() * TimeDelta;
...
HRESULT CLavaObject::Render_LightDepth()
{
...
HRESULT CLavaObject::Setup_Models()
{
	CModel* ComModel = nullptr;

	if (FAILED(__super::SetUp_Components(TEXT("Model0"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Starting_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model1"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Puzzle_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model2"), LEVEL_LAVA, TEXT("Prototype_Component_Model_NormalVerti_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model3"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Normal3_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model4"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Normal1_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model5"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Normal_Horizontal_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model6"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Merchant"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model7"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Choice2_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model8"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Choice_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model9"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Boss_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model10"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Restore_Object"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model11"), LEVEL_LAVA, TEXT("Prototype_Component_Model_LucidFount"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);
...
HRESULT CLavaObject::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	// LEVEL_LAVA -> Current LevelIndex·Î
...
HRESULT CLavaObject::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CLavaObject * CLavaObject::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CLavaObject*	pInstance = new CLavaObject(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CLavaObject"));
...
CGameObject * CLavaObject::Clone(void * pArg)
{
	CLavaObject*	pInstance = new CLavaObject(*this);
