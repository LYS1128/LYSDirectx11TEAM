#include "stdafx.h"
#include "..\Public\Ch_Player_Meteor_Floor_Effect.h"
...
CCh_Player_Meteor_Floor_Effect::CCh_Player_Meteor_Floor_Effect(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{
}

CCh_Player_Meteor_Floor_Effect::CCh_Player_Meteor_Floor_Effect(const CCh_Player_Meteor_Floor_Effect & rhs)
	: CGameObject(rhs)
{
}

HRESULT CCh_Player_Meteor_Floor_Effect::NativeConstruct_Prototype()
{
...
HRESULT CCh_Player_Meteor_Floor_Effect::NativeConstruct(void * pArg)
{
	...
	m_pTransformCom->Set_State(CTransform::STATE_POSITION, m_pTargetTransform->Get_State(CTransform::STATE_POSITION) + XMVectorSet(0.f, 0.1f, 0.f, 0.f));
	...
	CSound_Manager::GetInstance()->SoundPlay(L"Player_Meteor.ogg", CSound_Manager::PLAYER_RUCID1, SOUND_DEFAULT);


	return S_OK;
}

void CCh_Player_Meteor_Floor_Effect::Tick(_double TimeDelta)
{
...
void CCh_Player_Meteor_Floor_Effect::LateTick(_double TimeDelta)
{
	_double TimeRatio = CTime_Manager::Get_Instance()->Get_EctRatio();
	_double mTimeDelta = TimeDelta * TimeRatio;
...
HRESULT CCh_Player_Meteor_Floor_Effect::Render()
{
...
HRESULT CCh_Player_Meteor_Floor_Effect::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Texture */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Texture"), LEVEL_STATIC, TEXT("Prototype_Component_Texture_Ch_Player_MeteorFloorEffect"), (CComponent**)&m_pTextureCom)))
		return E_FAIL;

	return S_OK;
}

CCh_Player_Meteor_Floor_Effect * CCh_Player_Meteor_Floor_Effect::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CCh_Player_Meteor_Floor_Effect*	pInstance = new CCh_Player_Meteor_Floor_Effect(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CCh_Player_Meteor_Floor_Effect"));
...
CGameObject * CCh_Player_Meteor_Floor_Effect::Clone(void * pArg)
{
	CCh_Player_Meteor_Floor_Effect*	pInstance = new CCh_Player_Meteor_Floor_Effect(*this);
...
void CCh_Player_Meteor_Floor_Effect::Free()
{
	__super::Free();
