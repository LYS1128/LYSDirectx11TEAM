#include "stdafx.h"
#include "..\Public\Npc1.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc1::CNpc1(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc1::CNpc1(const CNpc1 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc1::NativeConstruct_Prototype()
{
...
HRESULT CNpc1::NativeConstruct(void * pArg)
{
...
void CNpc1::Tick(_double TimeDelta)
{
...
void CNpc1::LateTick(_double TimeDelta)
{
...
HRESULT CNpc1::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc1::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC1"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc1::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc1 * CNpc1::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc1*	pInstance = new CNpc1(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc1"));
...
CGameObject * CNpc1::Clone(void * pArg)
{
	CNpc1*	pInstance = new CNpc1(*this);
