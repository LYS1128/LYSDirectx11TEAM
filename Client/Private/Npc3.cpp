#include "stdafx.h"
#include "..\Public\Npc3.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc3::CNpc3(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc3::CNpc3(const CNpc3 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc3::NativeConstruct_Prototype()
{
...
HRESULT CNpc3::NativeConstruct(void * pArg)
{
...
void CNpc3::Tick(_double TimeDelta)
{
...
void CNpc3::LateTick(_double TimeDelta)
{
...
HRESULT CNpc3::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc3::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC3"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc3::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc3 * CNpc3::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc3*	pInstance = new CNpc3(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc3"));
...
CGameObject * CNpc3::Clone(void * pArg)
{
	CNpc3*	pInstance = new CNpc3(*this);
