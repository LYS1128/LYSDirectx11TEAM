#include "stdafx.h"
#include "..\Public\Meteor_Effect2.h"
#include "GameInstance.h"

#include "Time_Manager.h"


CMeteor_Effect2::CMeteor_Effect2(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CMeteor_Effect2::CMeteor_Effect2(const CMeteor_Effect2 & rhs)
	: CGameObject(rhs)
{
}

HRESULT CMeteor_Effect2::NativeConstruct_Prototype()
{
...
HRESULT CMeteor_Effect2::NativeConstruct(void * pArg)
{
...
void CMeteor_Effect2::Tick(_double TimeDelta)
{
...
void CMeteor_Effect2::LateTick(_double TimeDelta)
{
	_double TimeRatio = CTime_Manager::Get_Instance()->Get_PlayerRatio();
	_double mTimeDelta = TimeDelta * TimeRatio;
...
HRESULT CMeteor_Effect2::Render()
{
...
HRESULT CMeteor_Effect2::SetUp_Components()
{
	/* For.Com_Textrue */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Mesh_Meteor_Effect2"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CMeteor_Effect2::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CMeteor_Effect2 * CMeteor_Effect2::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CMeteor_Effect2*	pInstance = new CMeteor_Effect2(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CMeteor_Effect2"));
...
CGameObject * CMeteor_Effect2::Clone(void * pArg)
{
	CMeteor_Effect2*	pInstance = new CMeteor_Effect2(*this);
