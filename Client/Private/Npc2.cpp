#include "stdafx.h"
#include "..\Public\Npc2.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc2::CNpc2(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc2::CNpc2(const CNpc2 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc2::NativeConstruct_Prototype()
{
...
HRESULT CNpc2::NativeConstruct(void * pArg)
{
...
void CNpc2::Tick(_double TimeDelta)
{
...
void CNpc2::LateTick(_double TimeDelta)
{
...
HRESULT CNpc2::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc2::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC2"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc2::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc2 * CNpc2::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc2*	pInstance = new CNpc2(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc2"));
...
CGameObject * CNpc2::Clone(void * pArg)
{
	CNpc2*	pInstance = new CNpc2(*this);
