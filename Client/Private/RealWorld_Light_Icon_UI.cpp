...
void CRealWorld_Light_Icon_UI::Text_Image()
{
	...
	case Client::CRealWorld_Light_Icon_UI::IDEA_CUP:
		...
		m_iSprite = 13;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_HEROSKETCH://강한여성 초상화
		m_tUIInfo.fX = 600.f;
		m_tUIInfo.fSizeX = 181.f;
		m_tUIInfo.fSizeY = 20.f;
		m_iSprite = 41;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_POEM:// 추상적인시
		m_tUIInfo.fX = 558.f;
		m_tUIInfo.fSizeX = 94.f;
		m_tUIInfo.fSizeY = 18.f;
		m_iSprite = 42;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_SCENERY_PICTURE://평화로운 풍경의 그림
		m_tUIInfo.fX = 590.f;
		m_tUIInfo.fSizeX = 156.f;
		m_tUIInfo.fSizeY = 20.f;
		m_iSprite = 43;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_REDHAVEN_PICTURE://레드헤이븐 거리 사진
		m_tUIInfo.fX = 590.f;
		m_tUIInfo.fSizeX = 156.f;
		m_tUIInfo.fSizeY = 20.f;
		m_iSprite = 44;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_INTERNATIONAL_PICTURE://해외여행에서 찍은 사진
		m_tUIInfo.fX = 620.f;
		m_tUIInfo.fSizeX = 220.f;
		m_tUIInfo.fSizeY = 40.f;
		m_iSprite = 45;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_QUIRKYSONNET: //기발한 소네트
		m_tUIInfo.fX = 568.f;
		m_tUIInfo.fSizeX = 117.f;
		m_tUIInfo.fSizeY = 19.f;
		m_iSprite = 46;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_SWEATBANDWITHGEOMETRICPATTERN: //기하학적인 밴드
		m_tUIInfo.fX = 629.f;
		m_tUIInfo.fSizeX = 241.f;
		m_tUIInfo.fSizeY = 20.f;
		m_iSprite = 47;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_SMOOTHEARPLUGSCASE: // 귀마개
		m_tUIInfo.fX = 588.f;
		m_tUIInfo.fSizeX = 164.f;
		m_tUIInfo.fSizeY = 20.f;
		m_iSprite = 48;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_SEASHELLEARRINGS: //조개귀걸ㅇ;ㅣ
		m_tUIInfo.fX = 579.f;
		m_tUIInfo.fSizeX = 152.f;
		m_tUIInfo.fSizeY = 20.f;
		m_iSprite = 49;
		break;
	case Client::CRealWorld_Light_Icon_UI::IDEA_ILLUSTRATION_OF_REDHAVEN_FROM_THE_PAST: // 삽화
		m_tUIInfo.fX = 620.f;
