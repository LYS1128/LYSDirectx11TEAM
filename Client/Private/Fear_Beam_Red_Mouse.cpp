#include "stdafx.h"
#include "..\Public\Fear_Beam_Red_Mouse.h"
#include "GameInstance.h"
#include "Monster_Manager.h"
#include "Stage_Manager.h"

CFear_Beam_Red_Mouse::CFear_Beam_Red_Mouse(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{
}

CFear_Beam_Red_Mouse::CFear_Beam_Red_Mouse(const CFear_Beam_Red_Mouse & rhs)
	: CGameObject(rhs)	
{
}

HRESULT CFear_Beam_Red_Mouse::NativeConstruct_Prototype()
{
...
HRESULT CFear_Beam_Red_Mouse::NativeConstruct(void * pArg)
{

	m_MatPos = CMonster_Manager::Get_Instance()->Get_RedBeamMatrix();
...
void CFear_Beam_Red_Mouse::Tick(_double TimeDelta)
{
...
void CFear_Beam_Red_Mouse::LateTick(_double TimeDelta)
{
...
HRESULT CFear_Beam_Red_Mouse::Render()
{
...
HRESULT CFear_Beam_Red_Mouse::SetUp_Components()
{
	/* For.Com_Renderer */
...
CFear_Beam_Red_Mouse * CFear_Beam_Red_Mouse::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CFear_Beam_Red_Mouse*	pInstance = new CFear_Beam_Red_Mouse(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CFear_Beam_Red_Mouse"));
...
CGameObject * CFear_Beam_Red_Mouse::Clone(void * pArg)
{
	CFear_Beam_Red_Mouse*	pInstance = new CFear_Beam_Red_Mouse(*this);
...
void CFear_Beam_Red_Mouse::Free()
{
	__super::Free();
