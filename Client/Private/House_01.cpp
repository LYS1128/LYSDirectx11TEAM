#include "stdafx.h"
#include "..\Public\House_01.h"
#include "GameInstance.h"

CHouse_01::CHouse_01(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CMapObject(pDeviceOut, pDeviceContextOut)
{

}

CHouse_01::CHouse_01(const CHouse_01 & rhs)
	: CMapObject(rhs)
{
}

HRESULT CHouse_01::NativeConstruct_Prototype()
{
...
HRESULT CHouse_01::NativeConstruct(void * pArg)
{
...
void CHouse_01::Tick(_double TimeDelta)
{
...
void CHouse_01::LateTick(_double TimeDelta)
{
...
HRESULT CHouse_01::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
	...
	_vector vTargetPos = XMVectorSet(40.f, 0.f, 35.f, 1.f); //¸Ê Áß½ÉÁÂÇ¥
...
HRESULT CHouse_01::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_GAMEPLAY, TEXT("Prototype_Component_Model_House_01"), (CComponent**)&m_pModelCom)))
		return E_FAIL;
...
HRESULT CHouse_01::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CHouse_01 * CHouse_01::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CHouse_01*	pInstance = new CHouse_01(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CHouse_01"));
...
CGameObject * CHouse_01::Clone(void * pArg)
{
	CHouse_01*	pInstance = new CHouse_01(*this);
