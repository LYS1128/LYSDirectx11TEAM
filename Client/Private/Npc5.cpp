#include "stdafx.h"
#include "..\Public\Npc5.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc5::CNpc5(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc5::CNpc5(const CNpc5 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc5::NativeConstruct_Prototype()
{
...
HRESULT CNpc5::NativeConstruct(void * pArg)
{
...
void CNpc5::Tick(_double TimeDelta)
{
...
void CNpc5::LateTick(_double TimeDelta)
{
...
HRESULT CNpc5::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc5::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC5"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc5::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc5 * CNpc5::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc5*	pInstance = new CNpc5(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc5"));
...
CGameObject * CNpc5::Clone(void * pArg)
{
	CNpc5*	pInstance = new CNpc5(*this);
