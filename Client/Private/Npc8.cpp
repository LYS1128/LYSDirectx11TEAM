#include "stdafx.h"
#include "..\Public\Npc8.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc8::CNpc8(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc8::CNpc8(const CNpc8 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc8::NativeConstruct_Prototype()
{
...
HRESULT CNpc8::NativeConstruct(void * pArg)
{
...
void CNpc8::Tick(_double TimeDelta)
{
...
void CNpc8::LateTick(_double TimeDelta)
{
...
HRESULT CNpc8::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc8::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC8"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc8::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc8 * CNpc8::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc8*	pInstance = new CNpc8(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc8"));
...
CGameObject * CNpc8::Clone(void * pArg)
{
	CNpc8*	pInstance = new CNpc8(*this);
