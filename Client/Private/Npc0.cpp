#include "stdafx.h"
#include "..\Public\Npc0.h"
#include "GameInstance.h"
#include "Client_Level_Manager.h"

CNpc0::CNpc0(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CLandObject(pDeviceOut, pDeviceContextOut)
{

}

CNpc0::CNpc0(const CNpc0 & rhs)
	: CLandObject(rhs)
{
}

HRESULT CNpc0::NativeConstruct_Prototype()
{
...
HRESULT CNpc0::NativeConstruct(void * pArg)
{
...
void CNpc0::Tick(_double TimeDelta)
{
...
void CNpc0::LateTick(_double TimeDelta)
{
...
HRESULT CNpc0::Render_LightDepth()
{
	if (nullptr == m_pShaderCom ||
		nullptr == m_pModelCom)
		return E_FAIL;
...
HRESULT CNpc0::SetUp_Components()
{
	/* For.Com_Renderer */
	...
	/* For.Com_Model */
	if (FAILED(__super::SetUp_Components(TEXT("Com_Model"), LEVEL_STATIC, TEXT("Prototype_Component_Model_Ending_NPC0"), (CComponent**)&m_pModelCom)))
		return E_FAIL;

	return S_OK;
}

HRESULT CNpc0::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CNpc0 * CNpc0::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CNpc0*	pInstance = new CNpc0(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CNpc0"));
...
CGameObject * CNpc0::Clone(void * pArg)
{
	CNpc0*	pInstance = new CNpc0(*this);
