#include "stdafx.h"
#include "..\Public\LavaLand.h"
#include "GameInstance.h"
#include "Stage_Manager.h"
#include "Time_Manager.h"

CLavaLand::CLavaLand(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
	: CGameObject(pDeviceOut, pDeviceContextOut)
{

}

CLavaLand::CLavaLand(const CLavaLand & rhs)
	: CGameObject(rhs),
...
HRESULT CLavaLand::NativeConstruct_Prototype()
{
...
HRESULT CLavaLand::NativeConstruct(void * pArg)
{
...
void CLavaLand::Tick(_double TimeDelta)
{
...
void CLavaLand::LateTick(_double TimeDelta)
{
	_double mTimeDelta = CTime_Manager::Get_Instance()->Time_Stop() * TimeDelta;
...
HRESULT CLavaLand::Setup_Models()
{
	CModel* ComModel = nullptr;

	if (FAILED(__super::SetUp_Components(TEXT("Model0"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Starting_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model1"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Puzzle_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model2"), LEVEL_LAVA, TEXT("Prototype_Component_Model_NormalVerti_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model3"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Normal3_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model4"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Normal1_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model5"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Normal_Horizontal_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model6"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Choice2_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model7"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Choice_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);

	if (FAILED(__super::SetUp_Components(TEXT("Model8"), LEVEL_LAVA, TEXT("Prototype_Component_Model_Boss_Land"), (CComponent**)&ComModel)))
		return E_FAIL;
	m_Models.push_back(ComModel);
...
HRESULT CLavaLand::SetUp_Components()
{
	/* For.Com_Renderer */
...
HRESULT CLavaLand::SetUp_ConstantTable()
{
	CGameInstance*		pGameInstance = GET_INSTANCE(CGameInstance);
...
CLavaLand * CLavaLand::Create(ID3D11Device* pDeviceOut, ID3D11DeviceContext* pDeviceContextOut)
{
	CLavaLand*	pInstance = new CLavaLand(pDeviceOut, pDeviceContextOut);

	if (FAILED(pInstance->NativeConstruct_Prototype()))
	{
		MSG_BOX(TEXT("Failed to Created CLavaLand"));
...
CGameObject * CLavaLand::Clone(void * pArg)
{
	CLavaLand*	pInstance = new CLavaLand(*this);
